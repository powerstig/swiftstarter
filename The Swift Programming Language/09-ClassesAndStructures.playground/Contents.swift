...
// 结构体类型的成员初始化器 Memberwise Initializers for Structure Types
...
if tenEighty !== alsoTenEighty {
  print("tenEighty and alsoTenEighty not refer to the same VideoMode instance.")
}
